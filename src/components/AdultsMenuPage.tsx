      ...
      <div className="adults-menu-page-container">
        <div className="adults-menu-content-left">
          ...
          <div className="adults-menu-text-content">
            ...
            <p className="adults-menu-paragraph">
              По желание може да се поръчва допълнително всякакъв вид храни и
              напитки по договаряне – от специални плата и вегетариански
              предложения до любими напитки за вас и вашите гости.
            </p>
          </div>
          <button
            type="button"
