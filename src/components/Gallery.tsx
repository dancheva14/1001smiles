...
const galleryImages = [
  {
    id: 1,
    src: publicUrl("images/grandOpening.jpg"),
    alt: "Откриване",
    title: "Откриване",
    description:
      "Незабравими моменти от откриването на детската зала 1001 усмивки",
  },
  {
    id: 2,
    src: publicUrl("images/grandOpening2.jpg"),
    alt: "Откриване",
    title: "Откриване",
    description:
      "Незабравими моменти от откриването на детската зала 1001 усмивки",
  ...
  {
    id: 3,
    src: publicUrl("images/Hall/hall2.jpg"),
    alt: "Детска зала",
    title: "Детска зала",
  ...
  {
    id: 4,
    src: publicUrl("images/Hall/kidscenter1.jpg"),
    alt: "Детска зала",
    title: "Детска зала",
    description: "Вълнуващи моменти споделени с близки",
  },
  {
    id: 5,
    src: publicUrl("images/Hall/hall1.jpg"),
    alt: "Среща със спайдермен",
    title: "Среща със спайдермен",
  },
  {
    id: 6,
    src: publicUrl("images/Hall/kidscenter2.jpg"),
    alt: "Детска зала",
    title: "Детска зала",
    description: "Вълнуващи моменти споделени с близки",
  },
  {
    id: 7,
    src: publicUrl("images/Hall/kidscnter.jpg"),
    alt: "Детска зала",
    title: "Детска зала",
    description: "Вълнуващи моменти споделени с близки",
  },
